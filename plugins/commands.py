...
async def start_message(c,m):
    ...
    await m.reply_photo(f"https://i.imghippo.com/files/GS3653JdU.jpg",
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
                InlineKeyboardButton('💝 request massage ᴄʜᴀɴɴᴇʟ', url='https://t.me/movies_Group_Nh0')
            ],[
                InlineKeyboardButton("❣️ ᴅᴇᴠᴇʟᴏᴘᴇʀ", url='https://t.me/Kinsightweav'),
                InlineKeyboardButton("🤖 ᴜᴘᴅᴀᴛᴇ", url='https://t.me/new_updet')
            ]]
        )
    )
...
async def approve_new(client, m):
    ...
    try:
        ...
        try:
            await client.send_message(m.from_user.id, "**Hello {}!\nWelcome To {}\n\n__Powered By : @insightweav __**".format(m.from_user.mention, m.chat.title))
        except:
            pass
    except Exception as e:
        print(str(e))
